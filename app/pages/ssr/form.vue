    ...
    <div>
      <div class="top">
        ...
        <div>
          ...
          <p>This is being generated though Server Side rendering.</p>
        </div>
      </div>
...
const randomNumber = useState("my-random-state", () =>
  Math.floor(Math.random() * names.length),
);

const formData = ref(names[randomNumber.value] || names[1]);
